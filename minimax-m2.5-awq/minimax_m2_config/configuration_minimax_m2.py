# Vetted copy of configuration_minimax_m2.py from:
#   QuantTrio/MiniMax-M2.5-AWQ
#   snapshot: bbe738792c897da97ae0dfe5a47bd28a3a1ea10e
#
# Originally generated from src/transformers/models/minimax_m2/modular_minimax_m2.py
# by the HuggingFace team. Pure data class — no custom ops, no network access.
#
...
class MiniMaxM2Config(PretrainedConfig):
    ...
    Args:
        ...
        max_position_embeddings (`int`, *optional*, defaults to `4096*32`):
            The maximum sequence length this model might be used with.
        initializer_range (`float`, *optional*, defaults to 0.02):
            Standard deviation for weight matrix initialization.
        ...
        sliding_window (`int`, *optional*):
            Sliding window attention window size. Defaults to 4096 if not specified.
        attention_dropout (`float`, *optional*, defaults to 0.0):
            Dropout ratio for attention probabilities.
        num_experts_per_tok (`int`, *optional*, defaults to 2):
            Number of experts to route per token (top-k routing parameter).
        num_local_experts (`int`, *optional*, defaults to 8):
            Number of experts per Sparse MLP layer.
        output_router_logits (`bool`, *optional*, defaults to `False`):
            Whether router logits should be returned by the model.
        router_aux_loss_coef (`float`, *optional*, defaults to 0.001):
            Auxiliary loss factor for the total loss.
